  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4 transition-colors">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 w-full max-w-md">
        ...
        <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-2 text-center">Create Account</h2>
        <p className="text-gray-600 dark:text-gray-300 text-center mb-6">Sign up to get started</p>
